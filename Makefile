...
MBEDDRIVE=H:
PROJECT = loadmon
OBJECTS = ./MODSERIAL/ChangeLog.o ./IAP.o ./stepmotor_ctr.o ./SPIA2D.o ./SPITemp420.o ./COMfunc.o ./RTCfunc.o ./main.o ./MODSERIAL/FLUSH.o ./MODSERIAL/example_dma.o ./MODSERIAL/example2.o ./MODSERIAL/MODSERIAL.o ./MODSERIAL/example3a.o ./MODSERIAL/GETC.o ./MODSERIAL/ISR_TX.o ./MODSERIAL/example1.o ./MODSERIAL/INIT.o ./MODSERIAL/MODSERIAL_IRQ_INFO.o ./MODSERIAL/PUTC.o ./MODSERIAL/RESIZE.o ./MODSERIAL/ISR_RX.o ./MODSERIAL/example3b.o 
OBJECTS_DOS = .\IAP.o .\stepmotor_ctr.o .\SPIA2D.o .\SPITemp420.o  .\COMfunc.o .\RTCfunc.o .\main.o 
OBJECTS_DOS_ALL = .\IAP.o .\stepmotor_ctr.o .\SPIA2D.o .\SPITemp420.o  .\COMfunc.o .\RTCfunc.o .\main.o .\MODSERIAL\FLUSH.o .\MODSERIAL\example_dma.o .\MODSERIAL\example2.o .\MODSERIAL\MODSERIAL.o .\MODSERIAL\example3a.o .\MODSERIAL\GETC.o .\MODSERIAL\ISR_TX.o .\MODSERIAL\INIT.o .\MODSERIAL\MODSERIAL_IRQ_INFO.o .\MODSERIAL\PUTC.o .\MODSERIAL\RESIZE.o
